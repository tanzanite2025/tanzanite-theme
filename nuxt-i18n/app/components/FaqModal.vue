<template>
  <div class="w-full h-full bg-black rounded-2xl border-2 border-[#6b73ff] shadow-[0_0_30px_rgba(107,115,255,0.3)] overflow-hidden flex flex-col">
    <!-- Header -->
    <div class="flex items-center justify-between px-6 py-4 border-b border-white/10">
      <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#40ffaa] to-[#6b73ff]">
    ...
    <div class="flex-1 overflow-y-auto p-6">
      ...
      <!-- FAQ Content -->
      <div v-else-if="faqData && faqData.categories" class="space-y-6">
        <!-- Category Loop -->
        <div v-for="category in faqData.categories" :key="category.id" class="space-y-3">
          <!-- Category Header -->
